...
VALUES
	...
	,('Assai', 'Maria Stella')
	,('Roldão', 'Paulo César')
	,('Rossi','Pedro Paschoal')
	,('Dia', 'Giovanna Eduarda')
	,('Veran', 'Guilherme Machado')
